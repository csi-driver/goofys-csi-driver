...
import (
	...
	csicommon "github.com/csi-driver/goofys-csi-driver/pkg/csi-common"
...
const (
	...
	DriverName       = "goofys.csi.azure.com"
	separator        = "#"
...
func getStorageAccountFromSecretsMap(secrets map[string]string) (string, string, string, error) {
	...
	for k, v := range secrets {
		...
		case "accountname":
			accountName = v
		case "azurestorageaccountname": // for compatibility with built-in goofys plugin
			accountName = v
		case "accountkey":
			accountKey = v
		case "azurestorageaccountkey": // for compatibility with built-in goofys plugin
			accountKey = v
