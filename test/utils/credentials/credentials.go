...
const (
	...
	ResourceGroupPrefix         = "goofys-csi-driver-test-"
...
// Credentials is used in goofys CSI Driver to store Azure credentials
...
// goofys CSI driver tests and returns the credentials
...
// in Prow and returns the credential information usable to goofys CSI driver
